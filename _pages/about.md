...
<div style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: linear-gradient(135deg, rgba(0, 119, 182, 0.08) 0%, rgba(0, 180, 216, 0.08) 100%); border-radius: 8px; border-left: 3px solid var(--global-theme-color);">
☕ <em>Feel free to reach out for a quick chat!</em>
</div>
